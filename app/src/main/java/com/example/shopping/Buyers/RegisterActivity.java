...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CreateAccountBtn = (Button) findViewById(R.id.creat_account);
                ...
                if (!(dataSnapshot.child("Users").child(phone).exists()))
                {
                    ...
                    RootRef.child("Users").child(phone).updateChildren(userdataMap)
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                {
                                    Toast.makeText(RegisterActivity.this, "Your Information is saved ... go to Login your account", Toast.LENGTH_SHORT).show();
                                    ...
                                    auth.createUserWithEmailAndPassword(email , password)
                                            .addOnCompleteListener(RegisterActivity.this, new OnCompleteListener<AuthResult>() {
                                                ...
                                                public void onComplete(@NonNull Task<AuthResult> task) {
                                                    ...
                                                    {
                                                        Toast.makeText(RegisterActivity.this, "progress is failed ... try again", Toast.LENGTH_SHORT).show();
                                                    }
                                                }
                                            });
                                }
