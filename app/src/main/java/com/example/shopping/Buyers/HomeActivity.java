...
public class HomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView usernameTV = headerView.findViewById(R.id.user_profile_name);
        ...
        if (!type.equals("Admin")){
            ...
            productRef.child("Users").addListenerForSingleValueEvent(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    for (DataSnapshot ds : snapshot.getChildren()) {
                        String username = ds.child("name").getValue(String.class);
                        usernameTV.setText(username);
                        String imageView = ds.child("image").getValue(String.class) ;
                        Picasso.get().load(imageView).placeholder(R.drawable.profile).into(profileImageView);
